import {TemplateInterface, TemplateData } from '.'
export class Templates implements TemplateInterface{
    data:TemplateData = {  
    ...
    names = Object.keys(this.data)

    randomColor(name:string): string
    {
